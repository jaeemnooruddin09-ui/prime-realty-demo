export const SITE = {
  ...
  email: 'hello@primeforge-homes.demo',
  ...
  offices: [
    { city: 'New York', address: '120 Park Avenue, Suite 800, New York, NY 10017', phone: '+1 (212) 555-1000', email: 'newyork@primeforge-homes.demo' },
    { city: 'London', address: '40 Berkeley Square, Mayfair, London W1J 5AL', phone: '+44 20 7946 1000', email: 'london@primeforge-homes.demo' },
    { city: 'Dubai', address: 'Boulevard Plaza Tower 1, 27th Fl, Downtown Dubai', phone: '+971 4 555 1000', email: 'dubai@primeforge-homes.demo' },
    { city: 'Singapore', address: '1 Raffles Place, Tower 2, Level 36, Singapore 048616', phone: '+65 6555 1000', email: 'singapore@primeforge-homes.demo' },
    { city: 'Paris', address: '15 Avenue Montaigne, 75008 Paris, France', phone: '+33 1 5555 1000', email: 'paris@primeforge-homes.demo' },
  ],
  social: {
