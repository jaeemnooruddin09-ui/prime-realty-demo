export const SITE = {
  ...
  offices: [
    { city: 'New York', address: '120 Park Avenue, Suite 800, New York, NY 10017', phone: '+1 (212) 555-1000', email: 'newyork@primerealty.example' },
    { city: 'London', address: '40 Berkeley Square, Mayfair, London W1J 5AL', phone: '+44 20 7946 1000', email: 'london@primerealty.example' },
    { city: 'Dubai', address: 'Boulevard Plaza Tower 1, 27th Fl, Downtown Dubai', phone: '+971 4 555 1000', email: 'dubai@primerealty.example' },
    { city: 'Singapore', address: '1 Raffles Place, Tower 2, Level 36, Singapore 048616', phone: '+65 6555 1000', email: 'singapore@primerealty.example' },
    { city: 'Paris', address: '15 Avenue Montaigne, 75008 Paris, France', phone: '+33 1 5555 1000', email: 'paris@primerealty.example' },
  ],
  social: {
